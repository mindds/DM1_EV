...
An example command to run the pipeline is:
    ...
    PATH_OUT=/space/mindds/1/projects/ThurmanRNASeq/results/20211129_Wheeler_Muscle_stem_cell_transcriptome
    snakemake -s $BASE/snakemake_pipeline.py \
              --cores 2 \
              --directory=$PATH_OUT \
              --configfile="/space/mindds/1/projects/ThurmanRNASeq/scripts/20211129_Wheeler_Muscle_stem_cell_transcriptome/config.yaml" 
...
path_bbmap = "/space/mindds/1/software/bbmap"
exe_salmon = "/space/mindds/1/software/salmon-latest_linux_x86_64/bin/salmon"
exe_samtools = "/space/mindds/1/software/samtools-1.12/samtools"
exe_bedtools = "/space/mindds/1/software/bedtools2/bin/bedtools"
path_pipelineScripts = "/space/mindds/1/pipelines/rnaseq-pipeline/efs/Pipelines/RNAseq_pipeline/scripts"
job_name_sep = "-"
...
rule combine_fastqs:
    ...
    run:
        ...
        for f in params.files:
            ...
            shell('cp "{path_S3_in}/' + f + '" {params.sampleID}/{params.sampleID}.{params.read}.fastq.gz')
            shell("touch {output}")
